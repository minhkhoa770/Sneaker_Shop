...
-->
	...
	<div class="row">
		<div id="sidebar" class="span3">
			...
			<div class="well well-small">
				<a href="#"><img
					src="<c:url value ="/assets/user/img/slide/paypal.jpg"/>"
			...
			<ul class="nav nav-list promowrapper">
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							...
							VIEW</a> <img src="<c:url value ="/assets/user/img/slide/airforce1shadow.jpg"/>"
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img src="<c:url value ="/assets/user/img/slide/yeezy350.jpg"/>"
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="<c:url value ="/product-details/${ item.id_product }"/>"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img src="<c:url value ="/assets/user/img/slide/sbdunk.jpeg"/>"
							alt="bootstrap template">
						<div class="caption">
							<h4>
								<a class="defaultBtn" href="<c:url value ="/product-details/${ item.id_product }"/>">VIEW</a> <span
									class="pull-right">$22.00</span>
							</h4>
						</div>
					</div>
			 			...
			 			<li class="span3">
								<div class="thumbnail">
									<a class="zoomTool" href="<c:url value ="/product-details/${ item.id_product }"/>"
										...
										QUICK VIEW</a> <a href="<c:url value ="/product-details/${ item.id_product }"/>"><img
										src="<c:url value ="/assets/user/img/slide/${ item.img }"/>"
										alt=""></a>
								</div>
							</li>
			...
			<ul class="thumbnails">
				...
				<li class="span4">
					<div class="thumbnail">
						...
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <a href="<c:url value ="/product-details/${ item.id_product }"/>">
							<img src="<c:url value ="/assets/user/img/slide/${ item.img }"/>"
							alt=""></a>
						<div class="caption">
							<h5>${ item.name }</h5>
							<h4>
								<a class="defaultBtn" href="<c:url value ="/product-details/${ item.id_product }"/>"
