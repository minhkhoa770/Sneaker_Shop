...
<body>
	...
	<div class="well well-small">
		...
		<div class="row">
			<span style="margin-left: 25px;"></span> <select class="pull-right">
				<option>A - Z</option>
						...
						<li class="span4">
							<div class="thumbnail">
								<a href="product_details.html" class="overlay"></a> <a
									class="zoomTool" href="<c:url value ="/product-details/${ item.id_product }"/>"
									title="add to cart"><span class="icon-search"></span> QUICK
									VIEW</a> <a href="<c:url value ="/product-details/${ item.id_product }"/>">
									<img src="<c:url value ="/assets/user/img/slide/${ item.img }"/>" alt=""></a>
