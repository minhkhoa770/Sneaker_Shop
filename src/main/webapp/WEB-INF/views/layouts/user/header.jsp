...
<header id="header">
			<div class="row">
				<div class="span4">
					<h1>
						<a class="logo" href="home"><span>Twitter
								Bootstrap ecommerce template</span> <img
							src="<c:url value ="/assets/user/img/slide/logo-sneaker-shop.png"/>"
						...
						<c:if test="${ empty LoginInfo }">
							...
							<li class="dropdown"><a data-toggle="dropdown"
								...
								<div class="dropdown-menu">
									...
									<form action="login" method="POST" modelAttribute="user" class="form-horizontal loginFrm">
										<div class="control-group">
											<input type="email" class="span2" path="user"
												placeholder="Email">
										</div>
										<div class="control-group">
											<input type="password" class="span2" path="password"
